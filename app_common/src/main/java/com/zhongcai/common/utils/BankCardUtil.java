...
public class BankCardUtil  implements TextWatcher {
    ...
    public static void bind(TextView editText){
        new BankCardUtil(editText,DEFAULT_MAX_LENGTH);
    }
    public static void bind(TextView editText, int maxLength){
        new BankCardUtil(editText,maxLength);
    }

    public BankCardUtil(TextView editText, int maxLength){
    ...
    public void afterTextChanged(Editable s) {
        if (isChanged) {
            ...
            if(editText instanceof EditText){
                ...
                SpannableString text = new SpannableString(editText.getText());
                //set selection
                Selection.setSelection(text, selectionIndex < maxLength ? selectionIndex : maxLength);
            }
            isChanged = false;
