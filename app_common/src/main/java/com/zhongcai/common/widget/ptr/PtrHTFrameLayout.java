...
/**
 * viewpager滑动与Pull to Refresh的解决方法
 */
public class PtrHTFrameLayout extends PtrFrameLayout {
    ...
    private void initViews() {
        ...
        AnimPtrHeader header = new AnimPtrHeader(getContext());
     ...
     * @param hasViewPager
     */
    public void setViewPager(boolean hasViewPager) {
       this.hasViewPager = hasViewPager;
        final ViewConfiguration configuration = ViewConfiguration.get(getContext());
        mTouchSlop = ViewConfigurationCompat.getScaledPagingTouchSlop(configuration);
    }
    @Override
