...
/**
 * Created by Jwen on 2019/5/22.
 */

public class AESBase64Encrypt {
    private static final String HEX = "zhongcaizhongcai";
    private static final String CBC_PKCS5_PADDING = "AES/CBC/PKCS5Padding";//AES是加密方式 CBC是工作模式 PKCS5Padding是填充模式
    private static final String ECB_PKCS7_PADDING = "AES/ECB/PKCS7Padding";//AES是加密方式 ECB是工作模式 PKCS5Padding是填充模式
...
//            return Base64Encoder.encode(result);
    ...
    private static byte[] encrypt(String key, byte[] clear) throws Exception {
        ...
        cipher.init(Cipher.ENCRYPT_MODE, skeySpec, createIV(HEX));
...
//            byte[] enc = Base64Decoder.decodeToBytes(encrypted);
    ...
    private static byte[] decrypt(String key, byte[] encrypted) throws Exception {
        ...
        Cipher cipher = Cipher.getInstance(CBC_PKCS5_PADDING);
        cipher.init(Cipher.DECRYPT_MODE, skeySpec, createIV(HEX));
